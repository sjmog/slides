...
var LINES = [["Hello"], ["Welcome to Makers Academy"], ["It's", "Great", "Here"], ["It's", "Great", "Here"], ["It's", "Great", "Here"], ["Welcome to Makers Academy"], ["It's", "Great", "Here"], ["Great to see you!"], ["Welcome to Makers Academy"], ["Welcome to Makers Academy"], ["Hello"], ["Great to see you!"]];
...
var renderLine = function renderLine(line, container) {
  var segments = line.map(function (segment) {
    return mountSegment(segment);
  });
...
var render = function render(lines, container) {
  lines.forEach(function (line) {
    return renderLine(line, container);
  });
  $(container).bigtext({ maxfontsize: 10000 });
};

var offBottom = function offBottom(element) {
  return element.getBoundingClientRect().bottom > window.innerHeight;
};

var unveilNext = function unveilNext() {
